...
- SwiftData entities for product state and normalized content, including dedicated editorial records for handbook chapters, handbook sections, quick cards, and field references plus a separate local `PersistedPracticeProgress` record for quiz and weekly-drill completion.
