...
8. ~~Hardening, migration tests, and release preparation.~~ **Done:** `SchemaMigrationTests` (7), `SeedContentMigrationTests` (6), `OfflineStressTests` (7), `SafetyRegressionTests` expanded (+14 to 53 total). App Store materials, TestFlight feedback plan, and release-readiness evidence pack created. 277 unit + 1 UI tests pass.
