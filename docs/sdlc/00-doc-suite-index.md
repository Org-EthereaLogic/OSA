...
- Architecture confidence: high; Milestones 1–2 are complete and Milestone 3 Phases 1–4 (retrieval pipeline, sensitivity policy, citation packaging, capability detection, model adapter, and bounded Ask UI) are implemented. Remaining M3 work: prompt shaping and safety regression tests (M3P5).
