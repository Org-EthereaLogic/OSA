...
19. ADRs in [docs/adr](../adr/)
20. [Risk Register](./risk-register.md)
...
- Architecture confidence: high; Milestones 1–2 are complete and Milestone 3 Phases 1–5 (retrieval pipeline, sensitivity policy, citation packaging, capability detection, model adapter, bounded Ask UI, prompt shaping, prompt injection detection, and safety regression tests) are implemented. Milestone 3 core implementation is complete.
...
3. ~~Expand the first bundled seed packs into the broader MVP handbook, quick-card, and checklist corpus.~~ **In Progress:** Enhanced prompt created ([19-mvp-handbook-and-quick-card-corpus-expansion-enhanced-prompt.md](../prompt/enhanced/19-mvp-handbook-and-quick-card-corpus-expansion-enhanced-prompt.md)) and initial corpus expansion executed.
