...
- Document creation status: complete for initial v0.1 draft set; updated through Sprint 2 completion.
- Architecture confidence: high; Milestones 1–6 complete. Sprint 2 list ergonomics (search, pinning, swipe actions, context menus, recently viewed sections) implemented across Quick Cards, Notes, Checklists, Inventory, and Library. All UI surfaces are backed by live data. CI and quality automation in place. Siri App Intents with AssistantSchema, App Entities with Spotlight, FM-powered inventory completion, deep-link navigation intents, onscreen content manager, and RSS-based knowledge discovery with optional Brave Search enrichment all landed.
...
7. ~~Sprint 2 list ergonomics and discovery.~~ **Done:** Local search on Quick Cards, Notes, and Checklists; swipe actions on Inventory and Checklists; context menus on Quick Cards and Inventory; pin/unpin on Quick Cards and Handbook sections; Library recently viewed and topic browse. 396 XCTest (363 unit + 33 UI) plus 73 Swift Testing.
