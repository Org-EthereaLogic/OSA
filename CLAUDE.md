...
| `OSA/Domain/` | Domain models, repository protocols, and use-case boundaries; Emergency/ (EmergencyContact model and EmergencyContactRepository protocol); Inventory/ adds SupplyTemplate and SupplyTemplateRepository (hazard-scenario supply kits); Settings/ adds UserProfileSettings (onboarding state), AccessibilitySettings, PinnedContentSettings, RecentLibraryHistorySettings, InventoryAlertSettings (expiry notification toggle and lead-time picker) |
